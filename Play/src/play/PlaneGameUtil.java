...
public class PlaneGameUtil {
	 ...
	 * @param g
	 */
	public static void drawExplosion(int xpos, int ypos, Graphics g) {
		for (int i = Constants.EXPLOSION_ONE; i <= Constants.EXPLOSION_LAST; i++) {
			g.drawImage(getImage(i), xpos, ypos, null);
		}
	}
	...
	public static Bullet getBullet(int xpos, int ypos, int damage, int imageStyle, List<Bullet> bullets) {
		return new Bullet(xpos, ypos, damage, imageStyle, bullets);
	}
	...
	public static Plane getEnemyPlane(int xpos, int ypos, int damage, int imageStyle, int bulletStyle, int life,
			List<Plane> enemy, List<Drawable> noticeAndExplosion) {
		if (Constants.ME == imageStyle) {
			return null;
		}
		return new Plane(xpos, ypos, damage, imageStyle, bulletStyle, life, enemy, noticeAndExplosion);
	}
	 ...
	 * 
	 * @param xpos
	 *            The initial xpos of it.
	 * @param ypos
	 * @param imageStyle
	 *            The style of the image of the aerolite.
	 * @param damage
	 *            The damage of the it
	 * @param life
	 *            The life of it.
	 * @param enemy
	 *            The container that contains enemy
	 * @param noticeAndExplosion
	 * @return
	 */
	public static Aerolite getAerolite(int xpos, int ypos, int imageStyle, int damage, int life, List<Plane> enemy,
			List<Drawable> noticeAndExplosion) {
		return new Aerolite(xpos, ypos, getImage(imageStyle), damage, life, enemy, noticeAndExplosion);
	}
