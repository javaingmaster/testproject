...
public class Boss 
{
	...
	public void move(long time) //boss移动方式之一
	{
	...
	public boolean iscollision(ArrayList<Myfire> myfirelist,Boss point,Graphics g,Plane me)//待改成判断boss被哪一种火力打中导致不同结果，而且判断boss与me相撞
	{
		Myfire myfire;
