...
public class Plane 
{
	...
	public void collisionwithfireone(Graphics g,ArrayList<Enemy> enemyteam_one,ArrayList <Myfire> myattack,ArrayList <Paidfire> myattackone)//飞机是否捡到某个火力，待改成判断火力种类！
	{
		for(int p=0;p<enemyteam_one.size();p++)
		{
			 Enemy a=enemyteam_one.get(p);				 //以后决定是否添加remove检测
