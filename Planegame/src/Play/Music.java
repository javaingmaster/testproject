 ...
 * this: Music music = new * Music("music/add.wav");This class can only
...
public class Music {
	...
	public Music(String fileName) {
		try {
			AudioInputStream stream = AudioSystem.getAudioInputStream(this.getClass().getResource("/"+fileName));
